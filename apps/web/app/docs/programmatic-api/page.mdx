  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        <code>'apple'</code>, <code>'microsoft'</code>, <code>'okta'</code>, <code>'auth0'</code>,{" "}
        <code>'aws'</code>,{" "}
        <code>'durable-streams'</code>, <code>'resend'</code>, <code>'stripe'</code>, <code>'mongoatlas'</code>,{" "}
        <code>'clerk'</code>, or <code>'linear'</code>
      </td>
    </tr>
    <tr>
      <td>
...
<table>
  ...
  <tbody>
    ...
    <tr><td><code>@emulators/auth0</code></td><td>Auth0 identity provider / OIDC, Management API</td></tr>
    <tr><td><code>@emulators/cloudflare-os</code></td><td>Official Cloudflare OS local runtime proxy</td></tr>
    <tr><td><code>@emulators/mongoatlas</code></td><td>MongoDB Atlas Admin API + Data API</td></tr>
    <tr><td><code>@emulators/durable-streams</code></td><td>Durable Streams API</td></tr>
    ...
    <tr><td><code>@emulators/agent-vault</code></td><td>Infisical Agent Vault control-plane API</td></tr>
