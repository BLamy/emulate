...
Local drop-in replacement for Vercel, GitHub, Google, Slack, Apple, Microsoft, Okta, Auth0, AWS, Durable Streams, Resend, Stripe, MongoDB Atlas, Clerk, and Linear APIs. Built for CI and no-network sandboxes. Fully stateful, production-fidelity API emulation. Not mocks.
